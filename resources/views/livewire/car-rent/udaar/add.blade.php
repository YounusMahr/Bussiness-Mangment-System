    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-start justify-between">
                ...
                <a wire:navigate href="{{ localized_route('car-rent.udaar.index') }}" class="inline-flex items-center gap-2 text-sm text-slate-600 hover:text-slate-800">
        ...
        <div class="bg-white rounded-2xl shadow-soft-xl overflow-hidden">
            ...
            <form wire:submit.prevent="save" class="p-6 md:p-8">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-slate-200">
                    <a wire:navigate href="{{ localized_route('car-rent.udaar.index') }}" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium rounded-lg transition-colors">
                        Cancel
                    </a>
