                ...
                <div class="flex-auto p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500 mb-3">{{ __('messages.remaining_balance') }}</p>
                            <div class="text-2xl font-bold {{ $totalCashRemaining >= 0 ? 'text-gray-900' : 'text-red-600' }} mb-2">
                                Rs {{ number_format($totalCashRemaining, 2) }}
                            </div>
                        </div>
                        <div class="ml-4">
                            <div class="inline-flex w-16 h-16 items-center justify-center rounded-2xl bg-gradient-to-r from-purple-700 to-pink-500 text-white shadow-soft-2xl">
                    ...
                    <a wire:navigate href="{{ localized_route('grocery.cash.index') }}" class="block w-full mt-4 px-4 py-2 bg-gradient-to-r from-purple-700 to-pink-500 hover:from-purple-800 hover:to-pink-600 text-white text-center font-semibold rounded-lg transition-colors shadow-soft-2xl">
                        {{ __('view_details') }}
                    </a>
                </div>
            </div>
