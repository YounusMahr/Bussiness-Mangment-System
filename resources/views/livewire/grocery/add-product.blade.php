        ...
        <div class="mb-6">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-slate-600 mt-1">Create a product for your inventory</p>
                </div>
                <a wire:navigate href="{{ route('products') }}" class="inline-flex items-center gap-2 text-sm text-slate-600 hover:text-slate-800">
        ...
        <div class="bg-white rounded-2xl shadow-soft-xl overflow-hidden">
            ...
            <form wire:submit.prevent="save" class="p-6 md:p-8">
                ...
                <div class="pt-2 flex items-center justify-end gap-3">
                    <a wire:navigate href="{{ route('products') }}" class="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200">Cancel</a>
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r from-purple-700 to-pink-500 hover:from-purple-800 hover:to-pink-600 text-white rounded-lg">Save Product</button>
                </div>
            </form>
        </div>
    </div>
