...
<div class="p-6  bg-gray-50 min-h-screen">
    <div class=" mx-auto">
        ...
        <p class="text-slate-500">Record a sale for <strong>{{ $customer_name ?: 'selected customer' }}</strong> with dynamic product/quantity selection.</p>
        ...
        <form wire:submit.prevent="save" class="card shadow-soft-xl bg-white rounded-xl mt-4 p-6 md:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <span class="text-xs text-gray-400">Customer is pre-selected for this sale</span>
