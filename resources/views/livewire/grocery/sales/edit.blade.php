...
<div class="p-6  bg-gray-50 min-h-screen">
    <div class=" mx-auto">
        <h1 class="text-2xl font-bold mb-2 text-slate-900">Edit Sale / POS Entry</h1>
        <p class="text-slate-500">Update an existing sale with dynamic product/quantity selection.</p>
        ...
        @endif
        <form wire:submit.prevent="update" class="card shadow-soft-xl bg-white rounded-xl mt-4 p-6 md:p-8">
            <div class="mb-5">
