    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-start justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">{{ __('messages.edit_udaar') }}</h1>
                    <p class="text-slate-600 mt-1">{{ __('messages.update_credit_transaction') }}</p>
                </div>
