      ...
      <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/2">
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border my-4 mx-2">
          <div class="flex-auto p-6">
            <div class="flex items-center justify-between mb-4">
              <div class="flex-1">
                <h3 class="text-lg font-bold text-gray-900 mb-2">{{ __('sales_plots') }}</h3>
                <p class="text-sm text-gray-600 mb-3">{{ __('sales_plots_description') }}</p>
                <div class="text-2xl font-bold text-purple-600">
                  {{ number_format($salesPlots) }} {{ __('plots') }}
                </div>
              </div>
              <div class="ml-4">
                <div class="inline-block w-16 h-16 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 flex items-center justify-center">
      ...
      <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/2">
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border my-4 mx-2">
          <div class="flex-auto p-6">
            <div class="flex items-center justify-between mb-4">
              <div class="flex-1">
                <h3 class="text-lg font-bold text-gray-900 mb-2">{{ __('remaining_plots') }}</h3>
                <p class="text-sm text-gray-600 mb-3">{{ __('remaining_plots_description') }}</p>
                <div class="text-2xl font-bold text-purple-600">
                  {{ number_format($remainingPlots) }} {{ __('plots') }}
                </div>
              </div>
              <div class="ml-4">
                <div class="inline-block w-16 h-16 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 flex items-center justify-center">
