    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-start justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">{{ __('edit_plot_sale') }}</h1>
                    <p class="text-slate-600 mt-1">{{ __('update_plot_sale_information') }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-soft-xl overflow-hidden">
            ...
            <form wire:submit.prevent="update" class="p-6 md:p-8">
                <!-- Sale Details -->
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('sale_details') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="plot_purchase_id" class="block text-sm font-medium text-slate-700 mb-2">{{ __('plot') }} *</label>
                            <div class="relative">
                                ...
                                <select wire:model="plot_purchase_id" id="plot_purchase_id" class="w-full pl-12 pr-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent">
                                    <option value="">{{ __('select_plot') }}</option>
                ...
                <!-- Customer Details -->
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('customer_details') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="customer_name" class="block text-sm font-medium text-slate-700 mb-2">{{ __('customer_name') }} *</label>
                            <div class="relative">
                                ...
                                <input type="text" wire:model="customer_name" id="customer_name" class="w-full pl-12 pr-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent" placeholder="{{ __('enter_customer_name') }}">
                            </div>
                            @error('customer_name') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label for="customer_number" class="block text-sm font-medium text-slate-700 mb-2">{{ __('customer_number') }} *</label>
                            <div class="relative">
                                ...
                                <input type="text" wire:model="customer_number" id="customer_number" class="w-full pl-12 pr-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent" placeholder="{{ __('enter_customer_number') }}">
                            </div>
                ...
                <!-- Financial Details -->
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('financial_details') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="total_sale_price" class="block text-sm font-medium text-slate-700 mb-2">{{ __('total_sale_price') }} *</label>
                            <div class="relative">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">{{ __('auto_calculated') }}</p>
                ...
                <!-- Additional Details -->
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('additional_details') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                ...
                <div class="pt-2 flex items-center justify-end gap-3">
                    <a wire:navigate href="{{ localized_route('property.sale.index') }}" class="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200">{{ __('cancel') }}</a>
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r from-purple-700 to-pink-500 hover:from-purple-800 hover:to-pink-600 text-white rounded-lg">{{ __('update_plot_sale') }}</button>
                </div>
            </form>
        </div>
    </div>
