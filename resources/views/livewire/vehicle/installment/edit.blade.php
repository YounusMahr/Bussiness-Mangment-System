    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-start justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">{{ __('edit_installment') }}</h1>
                    <p class="text-slate-600 mt-1">{{ __('update_installment_record') }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-soft-xl overflow-hidden">
            ...
            <form wire:submit.prevent="update" class="p-6 md:p-8">
                ...
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('customer_information') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="customer_id" class="block text-sm font-medium text-slate-700 mb-2">{{ __('customer') }} *</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="customer_number" class="block text-sm font-medium text-slate-700 mb-2">{{ __('phone_number') }}</label>
                            <div class="relative">
                ...
                <!-- Vehicle Information -->
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('vehicle_information') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="vehicle" class="block text-sm font-medium text-slate-700 mb-2">{{ __('vehicle') }} ({{ __('optional') }})</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="model" class="block text-sm font-medium text-slate-700 mb-2">{{ __('model') }} ({{ __('optional') }})</label>
                            <div class="relative">
                ...
                <!-- Installment Details -->
                <div class="mb-8">
                    <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-4">{{ __('installment_details') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                            <label for="car_price" class="block text-sm font-medium text-slate-700 mb-2">{{ __('car_price') }} *</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="interest" class="block text-sm font-medium text-slate-700 mb-2">{{ __('interest') }} ({{ __('optional') }})</label>
                            <div class="relative">
                                <span class="pointer-events-none absolute inset-y-0 left-0 flex w-10 items-center justify-center text-slate-400">Rs</span>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">{{ __('calculated_automatically') }} ({{ __('car_price') }} + {{ __('interest') }})</p>
                            @error('total_price') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label for="paid" class="block text-sm font-medium text-slate-700 mb-2">{{ __('paid') }} *</label>
                            <div class="relative">
                                <span class="pointer-events-none absolute inset-y-0 left-0 flex w-10 items-center justify-center text-slate-400">Rs</span>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">{{ __('calculated_automatically') }} ({{ __('total_price') }} - {{ __('paid') }})</p>
                            @error('remaining') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label for="time_period" class="block text-sm font-medium text-slate-700 mb-2">{{ __('time_period') }} ({{ __('optional') }})</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="due_date" class="block text-sm font-medium text-slate-700 mb-2">{{ __('due_date') }} ({{ __('optional') }})</label>
                            <div class="relative">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            <label for="installment" class="block text-sm font-medium text-slate-700 mb-2">{{ __('installment_details') }} ({{ __('optional') }})</label>
                            <textarea wire:model="installment" id="installment" rows="3" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent placeholder:text-slate-400" placeholder="{{ __('enter_installment_details') }}"></textarea>
                        ...
                        <div>
                            ...
                            <textarea wire:model="note" id="note" rows="3" class="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent placeholder:text-slate-400" placeholder="{{ __('add_any_additional_notes') }}"></textarea>
                ...
                <div class="pt-2 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 text-white rounded-lg">{{ __('update_installment') }}</button>
                </div>
            </form>
        </div>
    </div>
