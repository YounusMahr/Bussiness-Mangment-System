    ...
    <div class="max-w-7xl mx-auto print-container">
        ...
        <div class="mb-6 no-print">
            <div class="flex items-start justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900">{{ __('messages.installment_history') }}</h1>
                    <p class="text-slate-600 mt-1">{{ __('messages.transaction_history_for') }} {{ $installment->customer->name ?? 'N/A' }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-soft-xl overflow-hidden mb-6 print-section">
            ...
            <div class="p-6 print-content">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 print-grid">
                    ...
                    <div>
                        <label class="text-sm font-medium text-slate-500">{{ __('messages.date') }}</label>
